...
WHERE 
    c.cate_name = 'Occasions';
";

$occasions_result = $conn->query($all_occasions);
...
<head>
    ...
    <title>Amour Roses | Occasions</title>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        if ($occasions_result->num_rows > 0) {
                            while ($row = $occasions_result->fetch_assoc()) {
                                ?>
                            ...
                            echo "<p class='text-center'>No products found in 'Cccasions' category.</p>";
                        }
                        ?>
